...
import com.yanyan.web.controller.staff.StaffController;
...
public class Test {
	...
	public static void main(String[] args) throws Exception {
        ...
        System.out.println(bean.getObject().toJson(DataResponse.success("aasss", new LoginModel())));*/
        try {
            ...
            //System.load("D:/Libraries/.m2/repository/org/fusesource/sigar/1.6.4/libsigar-amd64-winnt-1.6.4.dll");
    ...
    FileSystemXmlApplicationContext 	context = new FileSystemXmlApplicationContext("file:C:\\wujiajunVM\\yanyan\\yanyan\\yanyan-dubbox\\yanyan-webapp\\src\\main\\resources\\springmvc-servlet.xml");
    	
    	
    	   context.getBean("staffService");
