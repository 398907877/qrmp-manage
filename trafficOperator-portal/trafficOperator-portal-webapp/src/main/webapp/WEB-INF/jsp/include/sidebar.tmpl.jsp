...
<li>
    ...
    <ul>
        <li class="">
            <a href="ajax/layouts.html" title="Dashboard"><i class="fa fa-lg fa-fw fa-gear"></i> <span
                    class="menu-item-parent">App Layouts</span></a>
        </li>
        <li class="">
            <a href="ajax/skins.html" title="Dashboard"><i class="fa fa-lg fa-fw fa-picture-o"></i> <span
                    class="menu-item-parent">Prebuilt Skins</span></a>
        </li>
        <li>
...
<li>
    <a href="ajax/inbox.html"><i class="fa fa-lg fa-fw fa-inbox"></i> <span
            class="menu-item-parent">Outlook</span> <span
...
<li>
    ...
    <ul>
        ...
        <li>
            <a href="ajax/hchartable.html">HighchartTable <span
...
<li>
    ...
    <ul>
        ...
        <li>
            <a href="ajax/datatables.html">Data Tables <span
                    class="badge inbox-badge bg-color-greenLight hidden-xs">responsive</span></a>
        </li>
        <li>
...
<li>
    ...
    <ul>
        ...
        <li>
            <a href="ajax/libs.html">Form Plugins</a>
        </li>
        <li>
...
<li>
    ...
    <ul>
        <li>
            <a href="ajax/calendar.html"><i class="fa fa-lg fa-fw fa-calendar"></i> <span
                    class="menu-item-parent">Calendar</span></a>
        </li>
        <li>
            <a href="ajax/gmap-xml.html"><i class="fa fa-lg fa-fw fa-map-marker"></i> <span
...
<li>
    <a href="#"><i class="fa fa-lg fa-fw fa-puzzle-piece"></i> <span
            class="menu-item-parent">App Views</span></a>
    <ul>
        <li>
...
<li>
    <a href="#"><i class="fa fa-lg fa-fw fa-shopping-cart"></i> <span
            class="menu-item-parent">E-Commerce</span></a>
    <ul>
...
<li>
    ...
    <ul>
        <li>
            <a href="../Landing_Page/index.html" target="_blank">Landing Page <i
    ...
    <ul>
        <li>
            ...
            <div class="display-users">
                ...
                <a href="ajax/chat.html" class="btn btn-xs btn-default btn-block sa-chat-learnmore-btn">About
                    the API</a>
