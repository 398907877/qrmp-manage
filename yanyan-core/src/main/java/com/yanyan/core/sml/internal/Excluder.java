package com.yanyan.core.sml.internal;
...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public <T> TypeAdapter<T> create(final Sml sml, final TypeToken<T> type) {
        ...
        return new TypeAdapter<T>() {
            ...
            private TypeAdapter<T> delegate() {
                ...
                return d != null
                        ? d
                        : (delegate = sml.getDelegateAdapter(Excluder.this, type));
            }
        };
    }
