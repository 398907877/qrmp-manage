...
public class GenericsUtils {
     ...
     * @return
     */
    public static ParameterizedType getMapType(final Type keyType, final Type valueType, final Type rawType) {
        return getParameterType(new Type[]{keyType, valueType}, rawType);
    }
     ...
     * @return
     */
    public static ParameterizedType getCollectionType(final Type actualType, final Type rawType) {
        return getParameterType(new Type[]{actualType}, rawType);
    }

    public static ParameterizedType getParameterType(final Type[] actualTypeArguments, final Type rawType) {
        return getParameterType(actualTypeArguments, rawType, null);
    }

    public static ParameterizedType getParameterType(final Type[] actualTypeArguments, final Type rawType, final Type ownerType) {
